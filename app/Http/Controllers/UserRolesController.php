...
class UserRolesController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('users.roles.index',compact('data'))->with('i', ($request->input('page', 1) - 1) * 5);
    }

    public function create()
    {
        $roles = Role::pluck('name','name')->all();
        return view('users.roles.create',compact('roles'));
    }
    ...
    {
        $user = User::find($id);
        return view('users.roles.show',compact('user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('users.roles.edit',compact('user','roles','userRole'));
    }
